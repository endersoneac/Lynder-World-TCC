Public Class Personagem
    ...
    Private Sub btnEntrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEntrar.Click
        Dim questC As New QuestController
        Dim quest As New questModel
        quest = questC.carregarQuest(selecionado)

        If Not quest.codPersonagem = selecionado.cod Then
            quest = questC.gerarNovo(selecionado.cod)
        End If

        Dim jogo As New Principal(selecionado, quest)
        jogo.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub slot1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles slot1.Click, foto1.Click
        If controle.verificarPersonagem(personagem1) = True Then
    ...
    Private Sub slot2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles slot2.Click, foto2.Click
        If controle.verificarPersonagem(personagem2) = True Then
            carregarInformacoes(personagem2)
        Else
            Dim novopersonagem As New NovoPersonagem(2, usuario.codigo)
    ...
    Private Sub btnNovo2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNovo2.Click
        If controle.verificarPersonagem(personagem2) = True Then
            carregarInformacoes(personagem2)
        Else
            Dim novopersonagem As New NovoPersonagem(2, usuario.codigo)
    ...
    Private Sub btnNovo3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNovo3.Click
        If controle.verificarPersonagem(personagem2) = True Then
            carregarInformacoes(personagem2)
        Else
            Dim novopersonagem As New NovoPersonagem(2, usuario.codigo)
